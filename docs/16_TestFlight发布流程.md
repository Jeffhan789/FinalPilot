...
学呀学是一款面向期末冲刺和校招面试并行场景的 iOS 复习助手。App 根据 C310 多智能体、E320 神经网络、C315 云计算三门课程的真实考试时间，提供今日任务、两周计划、课程路线、练习题和校招准备清单。

What to Test:
请重点测试五个页面：今日、计划、课程、练习、校招。重点检查 2026-05-13 C310、2026-05-14 E320、2026-05-26 C315 的考试日期是否正确；计划页是否能清楚展示 A4 两周冲刺安排；固定路径同步面板在未开启本地服务时是否显示内置快照。
